...
const orientation = computed(() => breakpoints.smallerOrEqual('md').value ? 'vertical' : 'horizontal')

</script>

<template>
	<UButtonGroup id="tags" :orientation="orientation" class="pb-8 md:pb-12 w-full flex justify-center">
		<UButton
