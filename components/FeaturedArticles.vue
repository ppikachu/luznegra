    ...
    <div class="grid">
      ...
      >
        <a class="img" :href="`/article/${entry.fields.slug}`">
          <img
            v-if="entry.fields.imageFeatured"
            :src="`${entry.fields.imageFeatured.fields.file.url}?fm=webp`"
            :alt="entry.fields.imageFeatured.fields.title"
            class="max-w-full border-round"
            :loading="i > 0 ? 'lazy' : undefined"
          />
          <h1 class="text-3xl">{{ entry.fields.title }}</h1>
